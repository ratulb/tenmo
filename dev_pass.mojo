...
fn pass_to_device[dtype: DType](shape: UnsafePointer[Int64, MutAnyOrigin], strides: UnsafePointer[Int64, MutAnyOrigin], intarray: UnsafePointer[Int64, MutAnyOrigin], offset: Int = 2):
...
fn launch() raises:
    ...
    var intarray_buffer = ctx.enqueue_create_buffer[dtype](5)
