...
fn main() raises:
    ...
    # New tests
    test_argmin_1d_basic_cpu()
    test_argmax_1d_basic_cpu()
    test_argmin_1d_negative_values_cpu()
    test_argmax_1d_negative_values_cpu()
    test_argmin_1d_keepdims_cpu()
    test_argmin_2d_axis0_cpu()
    test_argmin_2d_axis1_cpu()
    test_argmax_2d_axis0_cpu()
    test_argmax_2d_axis1_cpu()
    test_argmin_2d_keepdims_axis0_cpu()
    test_argmax_2d_keepdims_axis1_cpu()
    test_argmin_2d_negative_axis_cpu()
    test_argmax_2d_single_row_cpu()
    test_argmin_2d_single_column_cpu()
    test_argmin_3d_axis0_cpu()
    test_argmin_3d_axis1_cpu()
    test_argmin_3d_axis2_cpu()
    test_argmax_3d_axis0_cpu()
    test_argmax_3d_axis1_cpu()
    test_argmax_3d_axis2_cpu()
    test_argmin_3d_keepdims_cpu()
    test_argmin_4d_axis0_cpu()
    test_argmax_4d_axis3_cpu()
    test_argmin_4d_negative_axis_cpu()
    test_argmin_all_same_values_cpu()
    test_argmax_all_same_values_cpu()
    test_argmin_single_element_cpu()
    test_argmax_with_zeros_cpu()
    test_argmin_1d_basic_gpu()
    test_argmax_1d_basic_gpu()
    test_argmin_1d_negative_values_gpu()
    test_argmax_1d_negative_values_gpu()
    test_argmin_2d_axis0_gpu()
    test_argmin_2d_axis1_gpu()
    test_argmax_2d_axis0_gpu()
    test_argmax_2d_axis1_gpu()
    test_argmin_2d_keepdims_axis0_gpu()
    test_argmax_2d_keepdims_axis1_gpu()
    test_argmin_2d_negative_axis_gpu()
    test_argmin_3d_axis0_gpu()
    test_argmin_3d_axis1_gpu()
    test_argmin_3d_axis2_gpu()
    test_argmax_3d_axis0_gpu()
    test_argmax_3d_axis1_gpu()
    test_argmax_3d_axis2_gpu()
