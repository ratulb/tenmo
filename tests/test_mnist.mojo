...
fn load_mnist_subset(
    ...
    var train_y = from_ndarray[DType.int32](train_labels_small, False)
    var test_x = from_ndarray[DType.float32](test_images_small, False)
    var test_y = from_ndarray[DType.int32](test_labels_small, False)
...
fn main() raises:
    ...
    # Check shapes
    print("train_x.shape:", train_x.shape)  # (1000, 784)
    print("train_y.shape:", train_y.shape, train_y.dtype)  # (1000,)
