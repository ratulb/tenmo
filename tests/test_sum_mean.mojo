...
fn main() raises:
    ...
    test_mean_1d_forward_cpu()
    test_mean_1d_forward_gpu()
    test_mean_1d_backward_cpu()
    test_mean_1d_backward_gpu()

    # 2D with axes
    test_sum_2d_axis0_cpu()
    test_sum_2d_axis0_gpu()
    test_sum_2d_axis1_cpu()
    test_sum_2d_axis1_gpu()
    test_sum_2d_keepdims_cpu()
    test_sum_2d_keepdims_gpu()
    test_sum_2d_backward_axis0_cpu()
    test_sum_2d_backward_axis0_gpu()
    test_mean_2d_axis0_cpu()
    test_mean_2d_axis0_gpu()

    # 3D
    test_sum_3d_all_cpu()
    test_sum_3d_all_gpu()
    test_sum_3d_axis12_cpu()
    test_sum_3d_axis12_gpu()
    test_mean_3d_axis0_cpu()
    test_mean_3d_axis0_gpu()

    # Gradient flow
    test_sum_grad_flow_chain_cpu()
    test_sum_grad_flow_chain_gpu()
    test_mean_grad_flow_scaling_cpu()
    test_mean_grad_flow_scaling_gpu()

    # Multiple backward
    test_sum_multiple_backward_cpu()
    test_sum_multiple_backward_gpu()

    # Edge cases
    test_sum_single_element_cpu()
    test_sum_single_element_gpu()
    test_sum_negative_axis_cpu()
    test_sum_negative_axis_gpu()
    test_sum_empty_axes_cpu()
    test_sum_empty_axes_gpu()
    test_mean_empty_axes_cpu()
    test_mean_empty_axes_gpu()

    # Large tensors
    test_sum_large_1d_cpu()
    test_sum_large_1d_gpu()
