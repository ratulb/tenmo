...
fn main() raises:
    ...
    test_gpu_sum_axis0_no_keepdims()
    test_gpu_sum_axis1_no_keepdims()
    test_gpu_sum_axis0_keepdims()
    test_gpu_sum_axis1_keepdims()
    test_gpu_sum_multi_axis_no_keepdims()
    test_gpu_sum_multi_axis_keepdims()
    test_gpu_sum_3d_axis1_keepdims()
    test_gpu_sum_negative_axis()
    test_gpu_sum_4d_middle_axes()
    test_gpu_sum_grad_accumulation()
    test_gpu_sum_matches_cpu()

    # Mean tests
    test_gpu_mean_full_reduction_scalar_grad()
    test_gpu_mean_axis0_no_keepdims()
    test_gpu_mean_axis1_no_keepdims()
    test_gpu_mean_axis0_keepdims()
    test_gpu_mean_axis1_keepdims()
    test_gpu_mean_3d_axis1_no_keepdims()
    test_gpu_mean_3d_axis1_keepdims()
    test_gpu_mean_multi_axis_no_keepdims()
    test_gpu_mean_multi_axis_keepdims()
    test_gpu_mean_negative_axis()
    test_gpu_mean_4d_middle_axes()
    test_gpu_mean_matches_cpu()
    test_gpu_mean_grad_accumulation()

    # Device transfer backward tests
    test_gpu_sum_grad_lands_on_cpu()
    test_gpu_mean_grad_lands_on_cpu()
    test_gpu_sum_cpu_tensor_unchanged_after_transfer()
    test_gpu_sum_chained_ops_grad_flow()
    test_gpu_mean_chained_with_sum_grad_flow()

    print("All GPU sum/mean tests passed.")
