...
fn main() raises:
    ...
    test_ce_ci_loss_positive()
    test_ce_ci_perfect_prediction()
    test_ce_ci_wrong_prediction()
    test_ce_ci_uniform_logits()
    test_ce_ci_batch4()
    print("Group A passed!")

    # Group B: Ignore Index CPU
    test_ce_ii_basic()
    test_ce_ii_all_ignored()
    test_ce_ii_first_ignored()
    test_ce_ii_custom_ignore_value()
    test_ce_ii_sum_reduction()
    test_ce_ii_none_reduction()
    print("Group B passed!")

    # Group C: Label Smoothing CPU
    test_ce_ls_basic()
    test_ce_ls_increases_entropy()
    test_ce_ls_formula()
    test_ce_ls_zero_is_standard()
    test_ce_ls_with_ignore()
    print("Group C passed!")

    # Group D: Multi-dimensional CPU
    test_ce_3d_basic()
    test_ce_3d_ignore_index()
    test_ce_3d_none_shape()
    test_ce_4d_basic()
    test_ce_5d_basic()
    ...
    # Group E: Probability Targets CPU
    test_ce_prob_basic()
    test_ce_prob_soft_labels()
    test_ce_prob_sum_reduction()
    test_ce_prob_none_reduction()
    test_ce_prob_label_smoothing()
    test_ce_prob_3d()
    print("Group E passed!")

    # Group F: Backward CI CPU
    test_ce_bwd_ci_grad_shape()
    test_ce_bwd_ci_grad_formula()
    test_ce_bwd_ci_grad_sums_to_zero()
    test_ce_bwd_ci_sum_reduction()
    test_ce_bwd_ci_ignore_zeros_grad()
    test_ce_bwd_ci_3d_ignore_zeros_grad()
    test_ce_bwd_ci_label_smoothing_grad()
    test_ce_bwd_ci_finite_difference()
    print("Group F passed!")

    # Group G: Backward Probs CPU
    test_ce_bwd_prob_grad_shape()
    test_ce_bwd_prob_formula()
    test_ce_bwd_prob_sums_to_zero()
    test_ce_bwd_prob_finite_difference()
    print("Group G passed!")

    # Group H: Train/Eval
    test_ce_mode_training_tracks_grad()
    test_ce_mode_eval_no_grad()
    test_ce_mode_train_eval_toggle()
    ...
    # Group J: GPU Backward CI
    test_ce_gpu_bwd_ci_grad_shape()
    test_ce_gpu_bwd_ci_parity()
    test_ce_gpu_bwd_ci_ignore_zeros_grad()
    test_ce_gpu_bwd_ci_3d_ignore()
    test_ce_gpu_bwd_ci_label_smoothing()
    print("Group J passed!")

    # Group K: GPU Probabilities
    test_ce_gpu_prob_forward_parity()
    test_ce_gpu_prob_backward_parity()
    test_ce_gpu_prob_label_smoothing_parity()
    print("Group K passed!")

    # Group L: Edge Cases
    test_ce_edge_single_class()
    test_ce_edge_large_batch()
    test_ce_edge_many_classes()
    test_ce_edge_numerically_stable_large_logits()
    test_ce_edge_numerically_stable_negative_logits()
    test_ce_edge_ignore_only_some_3d()
    test_ce_edge_zero_grad_no_requires_grad()
    print("Group L passed!")
