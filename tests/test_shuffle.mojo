...
fn main() raises:
    ...
    # CPU 1D
    test_shuf_cpu_1d_identity_perm()
    test_shuf_cpu_1d_reverse_perm()
    test_shuf_cpu_1d_arbitrary_perm()
    test_shuf_cpu_1d_grad_non_uniform_loss()

    # CPU 2D axis=0
    test_shuf_cpu_2d_axis0_identity()
    test_shuf_cpu_2d_axis0_reverse()
    test_shuf_cpu_2d_axis0_arbitrary()
    test_shuf_cpu_2d_axis0_grad_non_uniform()

    # CPU 2D axis=1
    test_shuf_cpu_2d_axis1_reverse()
    test_shuf_cpu_2d_axis1_arbitrary()

    # CPU 3D
    test_shuf_cpu_3d_axis0_reverse()
    test_shuf_cpu_3d_axis1_arbitrary()
    test_shuf_cpu_3d_axis2_reverse()
    test_shuf_cpu_3d_grad_non_uniform()

    # CPU 4D
    test_shuf_cpu_4d_axis0()
    test_shuf_cpu_4d_axis2()

    # CPU misc
    test_shuf_cpu_random_perm_grad_flow()
    test_shuf_cpu_random_perm_3d_grad_flow()
    test_shuf_cpu_track_grad_false()
    test_shuf_cpu_double_shuffle_roundtrip()
    test_shuf_cpu_shuffle_then_sum()
    test_shuf_cpu_shuffle_then_mean()

    # GPU 1D
    test_shuf_gpu_1d_identity_perm()
    test_shuf_gpu_1d_reverse_perm()
    test_shuf_gpu_1d_arbitrary_perm()
    test_shuf_gpu_1d_grad_non_uniform()

    # GPU 2D axis=0
    test_shuf_gpu_2d_axis0_reverse()
    test_shuf_gpu_2d_axis0_arbitrary()
    test_shuf_gpu_2d_axis0_grad_non_uniform()

    # GPU 2D axis=1
    test_shuf_gpu_2d_axis1_reverse()
    test_shuf_gpu_2d_axis1_arbitrary()

    # GPU 3D
    test_shuf_gpu_3d_axis0_reverse()
    test_shuf_gpu_3d_axis1_arbitrary()
    test_shuf_gpu_3d_axis2_reverse()
    test_shuf_gpu_3d_grad_non_uniform()

    # GPU 4D
    test_shuf_gpu_4d_axis0()
    test_shuf_gpu_4d_axis2()

    # GPU cross-validation
    test_shuf_gpu_matches_cpu_2d()
    test_shuf_gpu_matches_cpu_3d()
    test_shuf_gpu_matches_cpu_non_uniform_grad()

    # GPU misc
    test_shuf_gpu_random_perm_grad_flow()
    test_shuf_gpu_track_grad_false()
    test_shuf_gpu_grad_lands_on_cpu()
    test_shuf_gpu_double_shuffle_roundtrip()

    # GPU large axis dim — specifically tests DeviceBuffer permutation path
