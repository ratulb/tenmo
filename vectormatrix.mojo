...
@fieldwise_init
@register_passable
struct VectorMatmulNd_orig[dtype: DType](ImplicitlyCopyable):
    @staticmethod
    fn forward[
...
@fieldwise_init
@register_passable
struct VectorMatmulNdBackward_orig[dtype: DType](ImplicitlyCopyable):
    fn backward(
        self, output: Tensor[dtype]
    ) -> List[Tuple[Ancestor[dtype], Gradbox[dtype], Int]]:
        ref grad_out = output.gradients()[]  # GradBox: batch + [n]
