...
case $1 in
    sqrt)
        echo "Running mojo -I . tests/test_sqrt.mojo"
        mojo -I . $DEBUG_MODE tests/test_sqrt.mojo
        ;;
    unary)
        echo "Running mojo -I . tests/test_unary_ops.mojo"
        mojo -I . $DEBUG_MODE tests/test_unary_ops.mojo
        ;;
    tensors)
    ...
    gpu)
        ...
        ;;
    item)
        echo "Running mojo -I . tests/test_item.mojo"
        mojo -I . $DEBUG_MODE tests/test_item.mojo
        ;;
    contiguous)
        echo "Running mojo -I . tests/test_contiguous.mojo"
    ...
    maxmin_scalar)
        ...
        ;;
    onehot)
        echo "Running mojo -I . tests/test_onehot.mojo"
        mojo -I . $DEBUG_MODE tests/test_onehot.mojo
        ;;
    power)
        echo "Running mojo -I . tests/test_exponentiator.mojo"
        mojo -I . $DEBUG_MODE tests/test_exponentiator.mojo
        ;;
    allany)
        echo "Running mojo -I . tests/test_all_true_any_true.mojo"
        mojo -I . $DEBUG_MODE tests/test_all_true_any_true.mojo
        ;;
    compare)
        echo "Running mojo -I . tests/test_compare.mojo"
        mojo -I . $DEBUG_MODE tests/test_compare.mojo
        ;;
    count_unique)
        echo "Running mojo -I . tests/test_count_unique.mojo"
        mojo -I . $DEBUG_MODE tests/test_count_unique.mojo
        ;;
    transmute)
        echo "Running mojo -I . tests/test_transmutation.mojo"
        mojo -I . $DEBUG_MODE tests/test_transmutation.mojo
        ;;
    exp)
        echo "Running mojo -I . tests/test_exponential.mojo"
        mojo -I . $DEBUG_MODE tests/test_exponential.mojo
        ;;
    summean)
        echo "Running mojo -I . tests/test_sum_mean.mojo"
        mojo -I . $DEBUG_MODE tests/test_sum_mean.mojo
        ;;
    sigmoid)
        echo "Running mojo -I . tests/test_sigmoid.mojo"
        mojo -I . $DEBUG_MODE tests/test_sigmoid.mojo
        ;;
    gpusummean)
        ...
        ;;
    broadcast)
        echo "Running mojo -I . tests/test_broadcast.mojo"
        mojo -I . $DEBUG_MODE tests/test_broadcast.mojo
        ;;
    scalar)
    ...
    expand)
        echo "Running mojo -I . tests/test_expand.mojo"
        mojo -I . $DEBUG_MODE tests/test_expand.mojo
        ;;
    gpu_expand)
        echo "Running mojo -I . tests/test_gpu_expand.mojo"
        mojo -I . $DEBUG_MODE tests/test_gpu_expand.mojo
        ;;
    ...
    sgd)
        ...
        ;;
    npiop)
        echo "Running mojo -I . tests/test_numpy_interop.mojo"
    ...
    chunk)
        ...
        ;;
    cnn)
        echo "Running mojo -I . tests/test_cnn.mojo"
        mojo -I . $DEBUG_MODE tests/test_cnn.mojo
        ;;
    matmul)
        echo "Running mojo -I . tests/test_matmul.mojo"
        mojo -I . $DEBUG_MODE tests/test_matmul.mojo
        ;;
    ...
    all)
        echo "Running -I . tests/test_unary_ops.mojo"
        mojo -I . tests/test_unary_ops.mojo

        echo "Running -I . tests/test_sqrt.mojo"
        mojo -I . tests/test_sqrt.mojo
        ...
        echo "Running -I . tests/test_sum_mean.mojo"
        mojo -I . tests/test_sum_mean.mojo

        echo "Running -I . tests/test_exponential.mojo"
        mojo -I . tests/test_exponential.mojo

        echo "Running -I . tests/test_transmutation.mojo"
        mojo -I . tests/test_transmutation.mojo

        echo "Running -I . tests/test_count_unique.mojo"
        mojo -I . tests/test_count_unique.mojo

        echo "Running -I . tests/test_compare.mojo"
        mojo -I . tests/test_compare.mojo

        echo "Running -I . tests/test_all_true_any_true.mojo"
        mojo -I . tests/test_all_true_any_true.mojo

        echo "Running -I . tests/test_exponentiator.mojo"
        mojo -I . tests/test_exponentiator.mojo

        echo "Running -I . tests/test_onehot.mojo"
        mojo -I . tests/test_onehot.mojo
        ...
        echo "Running tests/test_item.mojo"
        mojo -I . tests/test_item.mojo

        echo "Running tests/test_scalar_tensors.mojo"
        mojo -I . tests/test_scalar_tensors.mojo

        echo "Running tests/test_broadcast.mojo"
        mojo -I . tests/test_broadcast.mojo

        echo "Running tests/test_gpu_expand.mojo"
        mojo -I . tests/test_gpu_expand.mojo

        echo "Running tests/test_expand.mojo"
        mojo -I . tests/test_expand.mojo
        ...
        echo "Running tests/test_numpy_interop.mojo"
        ...
        echo "Running tests/test_cnn.mojo"
        mojo -I . tests/test_cnn.mojo
