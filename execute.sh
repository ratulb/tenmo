...
run_test_by_name() {
  ...
  case $test_name in
    ndb_oop_arith)
      run_test "ndb_oop_arith" "tests/test_ndbuffer_arithmetic_gpu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    ndb_inp_arith)
      run_test "ndb_inp_arith" "tests/test_ndbuffer_inplace_gpu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    reshape)
      run_test "reshape" "tests/test_reshape.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    scalar_ops_gpu)
      run_test "scalar_ops_gpu" "tests/test_scalar_gpu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    embedding)
      run_test "embedding" "tests/test_embedding.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    dot)
      run_test "dot" "tests/test_dot.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    division)
      run_test "division" "tests/test_division.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    outer)
      run_test "outer" "tests/test_outer.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    layer_norm)
      run_test "layer_norm" "tests/test_layernorm.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    reciprocal)
      run_test "reciprocal" "tests/test_reciprocal.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    product)
      run_test "product" "tests/test_product_reduction.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    unary)
      run_test "unary" "tests/test_unary_ops.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    abs)
      run_test "abs" "tests/test_abs.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    sqrt)
      run_test "sqrt" "tests/test_sqrt.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    attn_matmul)
      run_test "attn_matmul" "tests/test_attn_matmul.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    bce)
      run_test "bce" "tests/test_bce.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    tensors)
    ...
    gpu)
      ...
      ;;
    item)
      run_test "item" "tests/test_item.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    contiguous)
      run_test "contiguous" "tests/test_contiguous.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    maxmin_scalar)
      run_test "maxmin_scalar" "tests/test_maxmin_scalar.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    onehot)
      run_test "onehot" "tests/test_onehot.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    power)
      run_test "power" "tests/test_exponentiator.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    allany)
      run_test "allany" "tests/test_all_true_any_true.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    compare)
      run_test "compare" "tests/test_compare.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    count_unique)
      run_test "count_unique" "tests/test_count_unique.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    transmute)
      run_test "transmute" "tests/test_transmutation.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    exp)
      run_test "exp" "tests/test_exponential.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    summean)
      ...
      ;;
    sigmoid)
      run_test "sigmoid" "tests/test_sigmoid.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    gpu_cpu)
      run_test "gpu_cpu" "tests/test_gpu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    gpusummean)
      run_test "gpusummean" "tests/test_gpu_sum_mean.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    broadcast)
      run_test "broadcast" "tests/test_broadcast.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    scalar)
      run_test "scalar" "tests/test_scalar_tensors.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    scalar_gpu)
      run_test "scalar_gpu" "tests/test_scalar_gpu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    inplace)
      run_test "inplace" "tests/test_inplace.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    expand)
      run_test "expand" "tests/test_expand.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    gpu_expand)
      run_test "gpu_expand" "tests/test_gpu_expand.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    sgd)
      run_test "sgd" "tests/test_sgd.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    sparse_sgd)
    ...
    scheduler)
      ...
      ;;
    npiop)
      run_test "npiop" "tests/test_numpy_interop.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    fill)
      run_test "fill" "tests/test_fill.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    chunk)
      run_test "chunk" "tests/test_chunk.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    cnn)
      run_test "cnn" "tests/test_cnn.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    matmul)
      run_test "matmul" "tests/test_matmul.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    pad)
      run_test "pad" "tests/test_pad.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    blas)
      run_test "blas" "tests/test_blas.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    dropout)
      run_test "dropout" "tests/test_dropout.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    dev_transfer)
      run_test "dev_transfer" "tests/test_device_transfer_gradflow.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    std_variance)
      run_test "std_variance" "tests/test_std_variance.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    stack)
      run_test "stack" "tests/test_stack.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    logarithm)
      run_test "logarithm" "tests/test_logarithm.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    concat)
      run_test "concat" "tests/test_concat.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    variance)
      run_test "variance" "tests/test_variance.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    variance_and_std)
      run_test "variance_and_std" "tests/test_variance_and_std.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    utils)
      run_test "utils" "tests/test_utils.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    accuracy)
      run_test "accuracy" "tests/test_accuracy.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    indexhelper)
      run_test "indexhelper" "tests/test_indexhelper.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    losses)
      run_test "losses" "tests/test_losses.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    abs)
      run_test "abs" "tests/test_abs.mojo" "$DEBUG_MODE"
      ...
      ;;
    cumsum)
      run_test "cumsum" "tests/test_cumsum.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    multinomial)
      run_test "multinomial" "tests/test_multinomial.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    tril)
      run_test "tril" "tests/test_tril.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    triu)
      run_test "triu" "tests/test_triu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    where)
      run_test "where" "tests/test_where.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    masked_fill)
      run_test "masked_fill" "tests/test_masked_fill.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    tanh)
      run_test "tanh" "tests/test_tanh.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    data)
      run_test "data" "tests/test_data.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    softmax)
      run_test "softmax" "tests/test_softmax.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    repeat)
      run_test "repeat" "tests/test_repeat.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    mmnd)
      run_test "mmnd" "tests/test_mmnd.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    intarray)
      run_test "intarray" "tests/test_intarray.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    mm2d)
      run_test "mm2d" "tests/test_mm2d.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    matmul_2d_verify)
      run_test "matmul_2d_verify" "tests/test_matmul_2d_verify.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    vm)
      run_test "vm" "tests/test_vm.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    mv)
      run_test "mv" "tests/test_mv.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    slice)
      run_test "slice" "tests/test_slice.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    view_slice)
      run_test "view_slice" "tests/test_view_slice.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    tiles)
      run_test "tiles" "tests/test_tiles.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    linspace)
      run_test "linspace" "tests/test_linspace.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    argminmax)
      run_test "argminmax" "tests/test_argminmax.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    minmax)
      run_test "minmax" "tests/test_minmax.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    relu)
      run_test "relu" "tests/test_relu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    shuffle)
      run_test "shuffle" "tests/test_shuffle.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    permute)
      run_test "permute" "tests/test_permute.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    retain_graph)
      run_test "retain_graph" "tests/test_retain_graph.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    flatten)
      run_test "flatten" "tests/test_flatten.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    gather)
      run_test "gather" "tests/test_gather.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    squeeze)
      run_test "squeeze" "tests/test_squeeze.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    unsqueeze)
      run_test "unsqueeze" "tests/test_unsqueeze.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    gradbox)
      run_test "gradbox" "tests/test_gradbox.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    ndb)
      run_test "ndb" "tests/test_ndb.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    transpose)
      run_test "transpose" "tests/test_transpose.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    buffers)
      run_test "buffers" "tests/test_buffers.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    views)
      run_test "views" "tests/test_views.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    shapes)
    ...
    strides)
      ...
      ;;
    shapebroadcast)
      run_test "shapebroadcast" "tests/test_broadcaster.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    validators)
      run_test "validators" "tests/test_validators.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    ce)
      run_test "ce" "tests/test_cross_entropy.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    checkpoint)
      run_test "checkpoint" "tests/test_checkpoint.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    module_list)
      run_test "module_list" "tests/test_module_list.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    synth_mnist)
      run_test "synth_mnist" "tests/test_synthetic_mnist.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    views_gpu)
      run_test "views_gpu" "tests/gpu/test_views_gpu.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    gpu_all)
      if [ -n "$chunk_arg" ]; then
    ...
    quick)
      ...
      run_test "tensors" "tests/test_tensors.mojo" "$DEBUG_MODE"
      exit_code=$?
      [ $exit_code -eq 0 ] && run_test "shapes" "tests/test_shapes.mojo" "$DEBUG_MODE"
      exit_code=$?
      [ $exit_code -eq 0 ] && run_test "strides" "tests/test_strides.mojo" "$DEBUG_MODE"
      exit_code=$?
      [ $exit_code -eq 0 ] && run_test "summean" "tests/test_sum_mean.mojo" "$DEBUG_MODE"
      exit_code=$?
      ;;
    all)
