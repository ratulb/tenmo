...
@fieldwise_init
struct FusedIm2ColBwdArg(ArgumentType):
    var N: Int
    var C_in: Int
    var H_pad: Int
    var W_pad: Int
...
@fieldwise_init
struct FusedIm2Col[dtype: DType](ImplicitlyCopyable, RegisterPassable):
    """
...
@fieldwise_init
struct FusedCol2ImBackward[dtype: DType](ImplicitlyCopyable, RegisterPassable):
    """
